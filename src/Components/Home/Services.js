        ...
        <div className="row mt-5">
          ...
          >
            ...
            <div className="text-center normal-text">
              Experience the complete and visually captivating toolkit designed specifically for Indian Sign Language (ISL). Our interface combines minimalism and informative design to provide a seamless user experience. With an extensive range of features encompassing essential functionalities for ISL, we have you covered. 
              Rest assured, we've thought of everything! Dive into our diverse services and kindly share your valuable feedback to enhance your experience with us.
            </div>
          </div>
        </div>
